...
DATASOURCE_PATHS = {"product-apim": ["repository/conf/datasources/master-datasources.xml",
                    ...
                    "product-is": [],
                    "product-ei": [],
                    "product-sp": ["/modules/integration/tests-kubernetes-integration/src/test/resources/artifacts/docker-files/deployment-ha-node-1.yaml", "/modules/integration/tests-kubernetes-integration/src/test/resources/artifacts/docker-files/deployment-ha-node-2.yaml"]}
M2_PATH = {"product-is": "is/wso2is", "product-apim": "am/wso2am",
           "product-ei": "ei/wso2ei", "product-sp": "sp/wso2sp"}
DIST_POM_PATH = {"product-is": "modules/distribution/pom.xml", "product-apim": "modules/distribution/product/pom.xml",
                 "product-ei": "distribution/pom.xml", "product-sp": "modules/distribution/pom.xml"}
...
DISTRIBUTION_PATH = {"product-apim": "modules/distribution/product/target",
                     ...
                     "product-ei": "modules/distribution/target", "product-sp": "modules/distribution/target"}
